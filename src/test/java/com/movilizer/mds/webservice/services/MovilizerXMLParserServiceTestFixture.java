...
import com.movilitas.movilizer.v16.MovilizerMovelet;
...
public abstract class MovilizerXMLParserServiceTestFixture {
    ...
    public void testLoadMoveletFromString() throws Exception {
        String moveletString = "" +
                ...
                "    xmlns=\"http://movilitas.com/movilizer/v16\" >\n" +
    ...
    public void testLoadRequestFromString() throws Exception {
        String moveletString = "<MovilizerRequest requestTrackingKey=\"\" systemId=\"1\" systemPassword=\"1\" \n" +
                ...
                "  useAutoAcknowledge=\"true\" xmlns=\"http://movilitas.com/movilizer/v16\">\n" +
                "  <moveletSet>\n" +
