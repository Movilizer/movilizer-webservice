...
public interface MovilizerDistributionService {
    ...
    /**
     * Read a Movilizer element from the webservice name space (MovilizerMovelet, MovilizerReply, etc...) and creates a
     ...
     * @throws com.movilizer.mds.webservice.exceptions.MovilizerXMLException when there are parsing problems.
     * @since 12.11.1.3
     */
     ...
     * @throws com.movilizer.mds.webservice.exceptions.MovilizerXMLException when there's parsing or file access problems.
     * @since 12.11.1.0
     */
     ...
     * @return the java instance parsed from the file.
     * @throws com.movilizer.mds.webservice.exceptions.MovilizerXMLException when there's parsing or string problems.
     * @since 12.11.1.1
     */
     ...
     * @throws com.movilizer.mds.webservice.exceptions.MovilizerXMLException if there's parsing problems.
     * @since 12.11.1.0
     */
     ...
     * @throws com.movilizer.mds.webservice.exceptions.MovilizerMAFManagementException when having troubles reading the file.
     ...
     * @throws com.movilizer.mds.webservice.exceptions.MovilizerMAFManagementException when having troubles uploading the file.
