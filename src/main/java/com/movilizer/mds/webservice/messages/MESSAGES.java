...
public final class MESSAGES {
    ...
    public static final String USING_PRIVATE_CONFIG = "Using private cloud configuration type with url '%s'";
    ...
    public static final String MAF_UPLOAD_FAILED_WITH_CODE = "Maf upload failed with code '%d'. Reason: %s";
    ...
    public static final String FINISHED_UPLOADING_MAF_SOURCE = "Finished uploading MAF source '%s' to system id '%d'";
    public static final String PROCESSING_MAF_SOURCE_FILE = "Processing MAF source file '%s' for uploading";
    public static final String FINISHED_UPLOADING_MAF_SOURCE_FILE = "Finished uploading MAF source file '%s' to system id '%d'";
