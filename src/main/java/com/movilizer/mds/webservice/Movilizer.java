...
public class Movilizer {
    public static final String SCHEMA = "META-INF/movilizer/wsdl/MovilizerTypesV11.xsd";
    public static final String WSDL = "META-INF/movilizer/wsdl/MovilizerV11Wsdl11.wsdl";
    public static final String ONLINE_WSDL = "META-INF/movilizer/wsdl/MovilizerOnlineV11Wsdl11.wsdl";
    public static final String ONLINE_INTERFACE = "com.movilitas.movilizer.v11.MovilizerOnlineWebServiceV11";
